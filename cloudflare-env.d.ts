/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: f8eea31c9d8b5c39281a0427e6189e02)
// Runtime types generated with workerd@1.20250508.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_BETTER_AUTH_URL: "https://t3-cloudflare-starter.pickboa.workers.dev";
		BETTER_AUTH_SECRET: "mxSlNyHVmY21G2D5IPRajnXxC1NqOXMM";
		NEXTJS_ENV: string;
		DATABASE_URL: string;
		ASSETS: Fetcher;
	}
